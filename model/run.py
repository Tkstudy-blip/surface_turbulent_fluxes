...
if __name__ == '__main__':
    ...
    parser.add_argument('--freq', type=str, default='30t',help='freq for time features encoding, options:[s:secondly, t:minutely, h:hourly, d:daily, b:business days, w:weekly, m:monthly], you can also use more detailed freq like 15min or 3h')
    ...
    parser.add_argument('--target_data_path', type=str, default='data.csv', help='data file')
